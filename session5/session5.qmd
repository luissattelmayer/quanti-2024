...
rd_table <- tibble(
  Term = c("Coefficient", "Std. Error", "z value", "P-value"),
  Estimate = c(rd_result$coef, rd_result$se, rd_result$z, rd_result$pv)
)

# Display using modelsummary
modelsummary(rd_table, output = "markdown")
